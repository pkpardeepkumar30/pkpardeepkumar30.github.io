...
The CV links to this page so web development remains visible without displacing scientific computing and teaching from the main professional narrative.
...
- The current PDF is generated by `scripts/generate_resume.py`; run `python scripts/generate_resume.py` after editing that script. It requires the Python package `reportlab`.
